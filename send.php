  ...
  if(isset($_POST['send'])) {
    ...
    if(empty($error)) {
        ...
        if(empty($mail->ErrorInfo)) {
            $result = "Ваш вопрос успешно отправлен.<br><a href='index.php'>Желаете отправить еще вопрос</a>?";
        } else {
            $result="";
            $error="При отправке письма возникла ошибка.<br>".$mail->ErrorInfo."<br>Пожалуйста, попробуйте еще раз.";
        }
        
    } else {
        $error="Обнаружены следующие ошибки:<br>".$error."<b>Пожалуйста, исправьте их и попробуйте еще раз.</b>";
    }
  }
  ?>